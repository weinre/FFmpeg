...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/whensunset/AndroidStudioProjects/KSVideoProject/ffmpeg/android/arm --target-os=linux --cross-prefix=/Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --arch=x86_64 --sysroot=/Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/platforms/android-16/arch-arm/ --extra-cflags='-Os -fpic -marm' --extra-ldflags= --cc=/Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --nm=/Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --enable-shared --enable-runtime-cpudetect --enable-gpl --enable-small --enable-cross-compile --disable-debug --disable-static --disable-doc --disable-asm --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-postproc --enable-avdevice --disable-symver --disable-stripping
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/platforms/android-16/arch-arm/ -isysroot /Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/platforms/android-16/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -Os -fpic -marm -std=c11 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -Os -fpic -marm -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/platforms/android-16/arch-arm/ -isysroot /Users/whensunset/AndroidStudioProjects/KSVideoProject/android-ndk-r14b/platforms/android-16/arch-arm/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
